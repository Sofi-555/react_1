 ...
 return (
    <div className="content-block">
        <div className="contact">
            <span className="text-part">Get in touch</span>
            <br></br><br></br>
            <span className="description">Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Nulla vitae elit libero, a pharetra augue. Nulla vitae elit libero, a pharetra augue. Sed posuere consectetur est at lobortis. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.<br></br><br></br>
            ...
            <br></br><br></br>
            <span className="text-title">E-mail address</span>
            <br></br>
            <input className="e-mail" placeholder="Enter your e-mail address"></input>
            <br></br><br></br>
            <span className="text-title">Message</span>
            <br></br>
